...
def convert_and_respect_annotation_metadata(
    *,
    ...
    # Avoid repeated expensive calls by caching origin and args per invocation
    ...
    if not isinstance(object_, str):
        ...
        elif origin in (list, typing.List, collections.abc.Sequence, typing.Sequence):
            if (
                (origin in (list, typing.List) and isinstance(object_, typing.List))
                or (origin in (collections.abc.Sequence, typing.Sequence) and isinstance(object_, typing.Sequence))
            ):
                inner_type = typing_extensions.get_args(clean_type)[0]
                return [
                    convert_and_respect_annotation_metadata(
